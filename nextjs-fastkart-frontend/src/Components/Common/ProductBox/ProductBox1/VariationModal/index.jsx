...
import LeftSideModal from '@/Components/Common/ProductBox/ProductBox1/VariationModal/LeftSideModal';
      ...
      <Row className='g-sm-4 g-2'>
        ...
        <Col lg='6'>
          <div className='right-sidebar-modal'>
            <RightVariationModal cloneVariation={cloneVariation} productObj={productObj}/>
