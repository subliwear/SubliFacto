...
const SellerStoreContent = () => {
  ...
  const { data, isLoading } = useQuery([page], () => request({ url: StoreAPI, params: { status: 1, page: page, paginate: 9 } }, router), { enabled: true, refetchOnWindowFocus: false, select: (res) => res?.data });
