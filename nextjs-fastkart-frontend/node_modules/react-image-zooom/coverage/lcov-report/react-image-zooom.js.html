...
<head>
    <title>Code coverage report for react-image-zooom.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> react-image-zooom.js</h1>
        <div class='clearfix'>
...
function ImageZoom({ zoom = "200", alt = "This is an imageZoom image", width = "100%", height = "auto", src, id, className, onError, errorContent = &lt;&gt;There was a problem loading your image&lt;/&gt; }) {
  ...
  const figureClass = imgData ? <span class="branch-0 cbranch-no" title="branch not covered" >"loaded" </span>: "loading";
...
&nbsp;
  const handleMove = <span class="fstat-no" title="function not covered" >(e</span>) =&gt; {
    // Handle the mouse move events
<span class="cstat-no" title="statement not covered" >    if (zoomed === "0") {</span>
<span class="cstat-no" title="statement not covered" >      zoomInPosition(e);</span>
    }
  }
&nbsp;
  const handleLeave = <span class="fstat-no" title="function not covered" >()</span> =&gt; {
    // Resets the state of the component on mouse leave
<span class="cstat-no" title="statement not covered" >    setZoomed("1");</span>
<span class="cstat-no" title="statement not covered" >    setPosition("50% 50%");</span>
  }
&nbsp;
  useEffect(() =&gt; {
...
&nbsp;
    ...
    setZoomed("0");
    let img = new Image();
    img.addEventListener("load", <span class="fstat-no" title="function not covered" >()</span> =&gt; {
...
<span class="cstat-no" title="statement not covered" >        setZoomed("1");</span>
<span class="cstat-no" title="statement not covered" >        setImgData(img.src);</span>
      }, 200);
    });
    img.addEventListener("error", <span class="fstat-no" title="function not covered" >(e</span>rror) =&gt; {
...
<span class="cstat-no" title="statement not covered" >      onError(); </span>// call onError if image fails to load
    });
    img.src = src;
  }, [onError, src]);
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    return (</span>
    ...
    return (
      &lt;Figure
        ...
        onMouseMove={<span class="fstat-no" title="function not covered" >(e</span>) =&gt; <span class="cstat-no" title="statement not covered" >handleMove(e)}</span>
        onMouseLeave={<span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >handleLeave()}</span>
      &gt;
        &lt;Img
          id="imageZoom"
          src={imgData}
