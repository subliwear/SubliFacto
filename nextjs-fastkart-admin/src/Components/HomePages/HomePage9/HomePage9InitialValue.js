const HomePage9InitialValue = (data) => {
    return {
        ...
        // Images
        homeBanner9Image: data?.content?.home_banner?.main_banner?.image_url ? { asset_url: data?.content?.home_banner?.main_banner?.image_url } : "",
        ...
        SliderProductBannerImage: data?.content?.slider_product_with_banner?.left_side_banners?.banner_1?.image_url ? { asset_url: data?.content?.slider_product_with_banner?.left_side_banners?.banner_1?.image_url } : "",

        couponBannerImage: data?.content?.coupon_banner?.image_url ? { asset_url: data?.content?.coupon_banner?.image_url } : "",
