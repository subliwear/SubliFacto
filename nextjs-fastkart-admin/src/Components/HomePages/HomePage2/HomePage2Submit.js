...
const HomePage2Submit = (values, mutate) => {
    ...
    if (values['homeMainBannerImage']) {
        values['content']['home_banner']['main_banner']['image_url'] = values['homeMainBannerImage'].asset_url
    } else values['content']['home_banner']['main_banner']['image_url'] = ""

    if (values['homeMainSubBanner1Image']) {
        values['content']['home_banner']['sub_banner_1']['image_url'] = values['homeMainSubBanner1Image'].asset_url
    } else values['content']['home_banner']['sub_banner_1']['image_url'] = ''

    if (values['homeMainSubBanner2Image']) {
        values['content']['home_banner']['sub_banner_2']['image_url'] = values['homeMainSubBanner2Image'].asset_url
    } else values['content']['home_banner']['sub_banner_2']['image_url'] = ''

    if (values['categoriesIconImage']) {
        values['content']['categories_icon_list']['image_url'] = values['categoriesIconImage'].asset_url
    } else values['content']['categories_icon_list']['image_url'] = ''

    if (values['couponImage']) {
        values['content']['coupons']['image_url'] = values['couponImage'].asset_url
    } else values['content']['coupons']['image_url'] = ''

    if (values['mainContentRightBanner1Image']) {
        values['content']['main_content']['sidebar']['right_side_banners']['banner_1']['image_url'] = values['mainContentRightBanner1Image'].asset_url
    } else values['content']['main_content']['sidebar']['right_side_banners']['banner_1']['image_url'] = ''

    if (values['mainContentRightBanner2Image']) {
        values['content']['main_content']['sidebar']['right_side_banners']['banner_2']['image_url'] = values['mainContentRightBanner2Image'].asset_url
