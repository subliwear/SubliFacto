const HomePage2InitialValue = (data) => {
    ...
    return {
        ...
        // Images 
        homeMainBannerImage: data?.content?.home_banner?.main_banner?.image_url ? { asset_url: data?.content?.home_banner?.main_banner?.image_url } : "",
        homeMainSubBanner1Image: data?.content?.home_banner?.sub_banner_1?.image_url ? { asset_url: data?.content?.home_banner?.sub_banner_1?.image_url } : "",
        homeMainSubBanner2Image: data?.content?.home_banner?.sub_banner_2?.image_url ? { asset_url: data?.content?.home_banner?.sub_banner_2?.image_url } : "",
        categoriesIconImage: data?.content?.categories_icon_list?.image_url ? { asset_url: data?.content?.categories_icon_list?.image_url } : "",
        couponImage: data?.content?.coupons?.image_url ? { asset_url: data?.content?.coupons?.image_url } : "",
        mainContentRightBanner1Image: data?.content?.main_content?.sidebar?.right_side_banners?.banner_1?.image_url ? { asset_url: data?.content?.main_content?.sidebar?.right_side_banners?.banner_1?.image_url } : "",
        mainContentRightBanner2Image: data?.content?.main_content?.sidebar?.right_side_banners?.banner_2?.image_url ? { asset_url: data?.content?.main_content?.sidebar?.right_side_banners?.banner_2?.image_url } : "",
