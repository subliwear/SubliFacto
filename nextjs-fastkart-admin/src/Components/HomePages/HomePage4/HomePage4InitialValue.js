const HomePage4InitialValue = (data) => {
    ...
    return {
        ...
        // Images
        homeBannerBackgroungImage: data?.content?.home_banner?.bg_image_url ? { asset_url: data?.content?.home_banner?.bg_image_url } : "",
        ...
        homeBannerSub1Image: data?.content?.home_banner?.sub_banner_1?.image_url ? { asset_url: data?.content?.home_banner?.sub_banner_1?.image_url } : "",

        homeBannerSub2Image: data?.content?.home_banner?.sub_banner_2?.image_url ? { asset_url: data?.content?.home_banner?.sub_banner_2?.image_url } : "",

        homeBannerSub3Image: data?.content?.home_banner?.sub_banner_3?.image_url ? { asset_url: data?.content?.home_banner?.sub_banner_3?.image_url } : "",

        categoryProductImage: data?.content?.categories_image_list?.image_url ? { asset_url: data?.content?.categories_image_list?.image_url } : "",

        twoColumnBanner1Image: data?.content?.two_column_banners?.banner_1?.image_url ? { asset_url: data?.content?.two_column_banners?.banner_1?.image_url } : "",

        twoColumnBanner2Image: data?.content?.two_column_banners?.banner_2?.image_url ? { asset_url: data?.content?.two_column_banners?.banner_2?.image_url } : "",

        fullWidthImage: data?.content?.full_width_banner?.image_url ? { asset_url: data?.content?.full_width_banner?.image_url } : "",

        newsLetterBgImage: data?.content?.news_letter?.bg_url ? { asset_url: data?.content?.news_letter?.bg_url } : "",
