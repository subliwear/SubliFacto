const HomePage3InitialValue = (data) => {
    ...
    return {
        ...
        seller_ids: data?.content?.seller?.store_ids  || [],
        brand_ids: data?.content?.brands?.brand_ids|| [],
        ...
        homeBannerSubBannerImage: data?.content?.home_banner?.sub_banner_1?.image_url ? { asset_url: data?.content?.home_banner?.sub_banner_1?.image_url } || '' : '',
        categoriesIconImage: data?.content?.categories_icon_list?.image_url ? { asset_url: data?.content?.categories_icon_list?.image_url } || '' : '',
        offerBannerImage: data?.content?.offer_banner?.image_url ? { asset_url: data?.content?.offer_banner?.image_url } || '' : '',
