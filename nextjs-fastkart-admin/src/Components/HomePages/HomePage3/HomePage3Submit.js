...
const HomePage3Submit = (values, mutate) => {
    ...
    if (values['brand_ids']) {
        values['content']['brands']['brand_ids'] = values['brand_ids']
    } 
    if (values['seller_ids']) {
        values['content']['seller']['store_ids'] = values['seller_ids']
    }
    // Images
    ...
    if (values['homeBannerSubBannerImage']) {
        values['content']['home_banner']['sub_banner_1']['image_url'] = values['homeBannerSubBannerImage'].asset_url
    ...
    if (values['offerBannerImage']) {
        values['content']['offer_banner']['image_url'] = values['offerBannerImage'].asset_url
    ...
    values['content']['product_bundles']['bundles'].forEach((elem, i) => {
        if (values[`productBundleImage${i}`]) {
            values['content']['product_bundles']['bundles'][i]['image_url'] = values[`productBundleImage${i}`].asset_url
