...
const HomePage1Submit = (values, mutate) => {
    ...
    if (values['homeBannerMainImage']) {
        values['content']['home_banner']['main_banner']['image_url'] = values['homeBannerMainImage'].asset_url
    } else values['content']['home_banner']['main_banner']['image_url'] = ''

    if (values['homeBannerSubBanner1Image']) {
        values['content']['home_banner']['sub_banner_1']['image_url'] = values['homeBannerSubBanner1Image'].asset_url
    } else values['content']['home_banner']['sub_banner_1']['image_url'] = ''

    if (values['homeBannerSubBanner2Image']) {
        values['content']['home_banner']['sub_banner_2']['image_url'] = values['homeBannerSubBanner2Image'].asset_url
    } else values['content']['home_banner']['sub_banner_2']['image_url'] = ''

    if (values['mainLeftBanner1']) {
        values['content']['main_content']['sidebar']['left_side_banners']['banner_1']['image_url'] = values['mainLeftBanner1'].asset_url
    } else values['content']['main_content']['sidebar']['left_side_banners']['banner_1']['image_url'] = ''

    if (values['mainLeftBanner2']) {
        values['content']['main_content']['sidebar']['left_side_banners']['banner_2']['image_url'] = values['mainLeftBanner2'].asset_url
    } else values['content']['main_content']['sidebar']['left_side_banners']['banner_2']['image_url'] = ''

    if (values['section2CategoryImage']) {
        values['content']['main_content']['section2_categories_list']['image_url'] = values['section2CategoryImage'].asset_url
    } else values['content']['main_content']['section2_categories_list']['image_url'] = ''

    if (values['section3Banner1']) {
        values['content']['main_content']['section3_two_column_banners']['banner_1']['image_url'] = values['section3Banner1'].asset_url
    } else values['content']['main_content']['section3_two_column_banners']['banner_1']['image_url'] = ''

    if (values['section3Banner2']) {
        values['content']['main_content']['section3_two_column_banners']['banner_2']['image_url'] = values['section3Banner2'].asset_url
    } else values['content']['main_content']['section3_two_column_banners']['banner_2']['image_url'] = ''

    if (values['section5CouponsImage']) {
        values['content']['main_content']['section5_coupons']['image_url'] = values['section5CouponsImage'].asset_url
    } else values['content']['main_content']['section5_coupons']['image_url'] = ''

    if (values['section6_twocolumnBanner1']) {
        values['content']['main_content']['section6_two_column_banners']['banner_1']['image_url'] = values['section6_twocolumnBanner1'].asset_url
    } else values['content']['main_content']['section6_two_column_banners']['banner_1']['image_url'] = ''

    if (values['section6_twocolumnBanner2']) {
        values['content']['main_content']['section6_two_column_banners']['banner_2']['image_url'] = values['section6_twocolumnBanner2'].asset_url
    } else values['content']['main_content']['section6_two_column_banners']['banner_2']['image_url'] = ''

    if (values['section8_VegitableImage']) {
        values['content']['main_content']['section8_full_width_banner']['image_url'] = values['section8_VegitableImage'].asset_url
    } else values['content']['main_content']['section8_full_width_banner']['image_url'] = ''

    if (values['mainContentSidebarCategoryImage']) {
        values['content']['main_content']['sidebar']['categories_icon_list']['image_url'] = values['mainContentSidebarCategoryImage'].asset_url
    ...
    values['content']['featured_banners']['banners'].forEach((elem, i) => {
        if (values[`featureBannerImage${i}`]) {
            values['content']['featured_banners']['banners'][i]['image_url'] = values[`featureBannerImage${i}`].asset_url
        } else {
