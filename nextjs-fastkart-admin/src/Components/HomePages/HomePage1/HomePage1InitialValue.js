const HomePage1InitialValue = (data) => {
    ...
    data?.content?.featured_banners?.banners.length > 0 &&
        data?.content?.featured_banners?.banners.forEach((elem, index) => {
            elem.image_url ? obj[`featureBannerImage${index}`] = { asset_url: elem.image_url } : '';
    ...
    return {
        ...
        // images
        homeBannerMainImage: data?.content?.home_banner?.main_banner?.image_url ? { asset_url: data?.content?.home_banner?.main_banner?.image_url } : "",
        homeBannerSubBanner1Image: data?.content?.home_banner?.sub_banner_1?.image_url ? { asset_url: data?.content?.home_banner?.sub_banner_1?.image_url } : "",
        homeBannerSubBanner2Image: data?.content?.home_banner?.sub_banner_2?.image_url ? { asset_url: data?.content?.home_banner?.sub_banner_2?.image_url } : "",
        mainLeftBanner1: data?.content?.main_content?.sidebar?.left_side_banners?.banner_1?.image_url ? { asset_url: data?.content?.main_content?.sidebar?.left_side_banners?.banner_1?.image_url } : "",
        mainLeftBanner2: data?.content?.main_content?.sidebar?.left_side_banners?.banner_2?.image_url ? { asset_url: data?.content?.main_content?.sidebar?.left_side_banners?.banner_2?.image_url } : "",
        newsLetterImage: data?.content?.news_letter?.image_url ? { asset_url: data?.content?.news_letter?.image_url } : "",

        section2CategoryImage: data?.content?.main_content?.section2_categories_list?.image_url ? { asset_url: data?.content?.main_content?.section2_categories_list?.image_url } : "",
        section3Banner1: data?.content?.main_content?.section3_two_column_banners?.banner_1?.image_url ? { asset_url: data?.content?.main_content?.section3_two_column_banners?.banner_1?.image_url } : "",
        section3Banner2: data?.content?.main_content?.section3_two_column_banners?.banner_2?.image_url ? { asset_url: data?.content?.main_content?.section3_two_column_banners?.banner_2?.image_url } : "",
        section5CouponsImage: data?.content?.main_content?.section5_coupons?.image_url ? { asset_url: data?.content?.main_content?.section5_coupons?.image_url } : "",
        section6_twocolumnBanner1: data?.content?.main_content?.section6_two_column_banners?.banner_1?.image_url ? { asset_url: data?.content?.main_content?.section6_two_column_banners?.banner_1?.image_url } : "",
        section6_twocolumnBanner2: data?.content?.main_content?.section6_two_column_banners?.banner_2?.image_url ? { asset_url: data?.content?.main_content?.section6_two_column_banners?.banner_2?.image_url } : "",
        section8_VegitableImage: data?.content?.main_content?.section8_full_width_banner?.image_url ? { asset_url: data?.content?.main_content?.section8_full_width_banner?.image_url } : "",
        mainContentSidebarCategoryImage: data?.content?.main_content?.sidebar?.categories_icon_list?.image_url ? { asset_url: data?.content?.main_content?.sidebar?.categories_icon_list?.image_url } : "",
        ...obj,
    }
}
