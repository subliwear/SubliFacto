...
const ActivationTab = () => {
  ...
  return (
    <>
      ...
      <CheckBoxField name="[values][activation][guest_checkout]" title="GuestCheckout"  />
      <CheckBoxField name="[values][activation][trek_order]" title="TrekOrder"  />
      <CheckBoxField name="[values][activation][login_number]" title="Login Number"  />
      <CheckBoxField name="[values][activation][send_sms]" title="Send SMS"  />
    </>
  );
};
